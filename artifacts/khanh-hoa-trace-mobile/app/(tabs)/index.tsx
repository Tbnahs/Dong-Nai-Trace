    ...
    >
      ...
      <View style={[styles.topHeader, { paddingTop: topPad + 10, borderBottomColor: colors.border }]}>
        <Pressable onPress={() => router.push('/')} style={styles.brand} hitSlop={6}>
          <Image source={require('@/assets/images/logo-khanh-hoa.png')} style={styles.logo} />
          <View>
            <Text style={[styles.brandName, { color: colors.primary }]}>KHÁNH HÒA TRACE</Text>
      ...
      <View style={styles.hero}>
        ...
        <Text style={[styles.heroDesc, { color: colors.mutedForeground }]}>
          Nhờ ứng dụng công nghệ tiên tiến, hệ thống cho phép định danh, truy vết nguồn gốc sản phẩm hàng hóa tại Tỉnh Khánh Hòa.
        </Text>
