  ...
  return (
    ...
    >
      ...
      <View style={[styles.loginBrand, { borderBottomColor: colors.border }]}>
        <Image source={require('@/assets/images/logo-khanh-hoa.png')} style={styles.loginLogo} />
        <View style={{ flex: 1 }}>
          <Text style={[styles.loginBrandName, { color: colors.primary, fontFamily: 'BeVietnamPro_700Bold' }]}>KHÁNH HÒA TRACE</Text>
        ...
        <View style={{ gap: 12, marginTop: 20 }}>
          ...
          <View>
            <View style={styles.passwordLabelRow}>
              ...
              <Pressable onPress={() => Alert.alert('Quên mật khẩu?', 'Vui lòng liên hệ Sở KH&CN Khánh Hòa: skhcn@khanhhoa.gov.vn')}>
