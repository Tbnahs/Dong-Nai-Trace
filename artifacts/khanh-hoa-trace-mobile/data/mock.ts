...
export const PRODUCTS: Product[] = [
  {
    ...
    certificationDocuments: [{
      name: 'VietGAP',
      issuer: 'Sở NN&PTNT tỉnh Khánh Hòa',
      expiry: '30/09/2025',
  ...
  },
  {
    ...
    businessId: 'b4',
    businessName: 'Trang trại Sạch Khánh Hòa',
    origin: 'Biên Hòa, Khánh Hòa',
    district: 'Biên Hòa',
    province: 'Khánh Hòa',
    category: 'Nông sản & Rau củ',
    certifications: ['VietGAP'],
  ...
  },
  {
    ...
    businessId: 'b2',
    businessName: 'Công ty Thủy sản Khánh Hòa',
  ...
  },
  {
    ...
    origin: 'Định Quán, Khánh Hòa',
    district: 'Định Quán',
    province: 'Khánh Hòa',
    category: 'Nông sản & Rau củ',
    certifications: ['OCOP'],
    description: 'Dưa hấu không hạt Định Quán được trồng theo quy trình an toàn, vỏ mỏng, ruột đỏ, ngọt mát, đạt tiêu chuẩn OCOP tỉnh Khánh Hòa.',
  ...
  },
  {
    ...
    businessId: 'b8',
    businessName: 'Trang trại Ong Rừng Khánh Hòa',
    origin: 'Tân Phú, Khánh Hòa',
    district: 'Tân Phú',
    province: 'Khánh Hòa',
    category: 'Thực phẩm chế biến',
    certifications: ['OCOP'],
...
export const BUSINESSES: Business[] = [
  {
    ...
    type: 'Hợp tác xã',
    district: 'Vĩnh Cửu',
    address: 'Xã Tân Triều, Huyện Vĩnh Cửu, Khánh Hòa',
    phone: '0251 890 123',
  ...
  {
    id: 'b2',
    name: 'Công ty Thủy sản Khánh Hòa',
    shortName: 'Thủy sản ĐN',
    type: 'Doanh nghiệp',
    district: 'Long Thành',
    address: 'KCN Long Thành, Huyện Long Thành, Khánh Hòa',
    phone: '0251 234 567',
  ...
  },
  {
    ...
    type: 'Hợp tác xã',
    district: 'Định Quán',
    address: 'Xã Phú Vinh, Huyện Định Quán, Khánh Hòa',
    phone: '0251 345 678',
    ...
    productIds: ['sp006'],
    description: 'HTX Dưa hấu Định Quán chuyên sản xuất dưa hấu không hạt theo tiêu chuẩn an toàn thực phẩm, đạt OCOP tỉnh Khánh Hòa, phân phối toàn quốc.',
    productCount: 3,
    image: 'https://images.unsplash.com/photo-1563114773-84221bd62daa?w=600&h=400&fit=crop',
  },
  {
    id: 'b4',
    name: 'Trang trại Sạch Khánh Hòa',
    shortName: 'TT Sạch ĐN',
    type: 'Trang trại',
    district: 'Biên Hòa',
    address: 'Phường Hóa An, TP. Biên Hòa, Khánh Hòa',
    phone: '0251 456 789',
    email: 'ttsach.khanhhoa@gmail.com',
    representative: 'Phạm Văn Đức',
    taxCode: '3600444444',
    certifications: ['VietGAP', 'GlobalGAP'],
    productIds: ['sp002'],
    description: 'Trang trại Sạch Khánh Hòa sản xuất rau củ theo tiêu chuẩn VietGAP và GlobalGAP, cung cấp cho hệ thống siêu thị Big C, Co.opmart và bếp ăn công nghiệp.',
    productCount: 12,
  ...
  },
  {
    ...
    type: 'Hợp tác xã',
    district: 'Long Khánh',
    address: 'Xã Bảo Quang, TP. Long Khánh, Khánh Hòa',
    phone: '0251 567 890',
  ...
  },
  {
    ...
    type: 'Doanh nghiệp',
    district: 'Nhơn Trạch',
    address: 'KCN Nhơn Trạch III, Huyện Nhơn Trạch, Khánh Hòa',
    phone: '0251 678 901',
  ...
  },
  {
    ...
    type: 'Cơ sở sản xuất',
    district: 'Xuân Lộc',
    address: 'Xã Xuân Thọ, Huyện Xuân Lộc, Khánh Hòa',
    phone: '0251 789 012',
  ...
  {
    id: 'b8',
    name: 'Trang trại Ong Rừng Khánh Hòa',
    shortName: 'Ong Rừng ĐN',
    type: 'Trang trại',
    district: 'Tân Phú',
    address: 'Xã Phú Lâm, Huyện Tân Phú, Khánh Hòa',
    phone: '0251 890 234',
    email: 'ongrung.khanhhoa@gmail.com',
    representative: 'Hoàng Văn Lâm',
    taxCode: '3600888888',
    certifications: ['OCOP', 'Hữu cơ'],
    productIds: ['sp007'],
    description: 'Trang trại Ong Rừng Khánh Hòa khai thác và chế biến mật ong rừng tự nhiên tại huyện Tân Phú, sản phẩm đạt OCOP 3 sao, 100% nguyên chất không pha trộn.',
    productCount: 3,
  ...
  },
  {
    ...
    type: 'Hợp tác xã',
    district: 'Định Quán',
    address: 'Xã Phú Cường, Huyện Định Quán, Khánh Hòa',
    phone: '0251 901 234',
  ...
  },
  {
    ...
    type: 'Doanh nghiệp',
    district: 'Biên Hòa',
    address: 'KCN Biên Hòa 2, TP. Biên Hòa, Khánh Hòa',
    phone: '0251 012 345',
  ...
  },
  {
    ...
    type: 'Cơ sở sản xuất',
    district: 'Long Khánh',
    address: 'Phường Xuân An, TP. Long Khánh, Khánh Hòa',
    phone: '0251 111 222',
  ...
  },
  {
    ...
    type: 'Làng nghề',
    district: 'Vĩnh Cửu',
    address: 'Xã Trị An, Huyện Vĩnh Cửu, Khánh Hòa',
    phone: '0251 222 333',
    email: 'langngheTrAn@khanhhoa.gov.vn',
...
export const NEWS: NewsItem[] = [
  {
    ...
    excerpt: 'Sở Khoa học và Công nghệ Khánh Hòa chính thức ra mắt nền tảng Khánh Hòa Trace, kết nối hơn 200 doanh nghiệp và hợp tác xã trên địa bàn tỉnh vào hệ thống truy xuất nguồn gốc điện tử.',
    content: `Sở Khoa học và Công nghệ Khánh Hòa chính thức ra mắt nền tảng Khánh Hòa Trace, kết nối hơn 200 doanh nghiệp và hợp tác xã trên địa bàn tỉnh vào hệ thống truy xuất nguồn gốc điện tử.\n\nHệ thống sử dụng công nghệ mã QR và dữ liệu minh bạch để ghi nhận và xác thực thông tin về nguồn gốc, quy trình sản xuất của các sản phẩm nông nghiệp trên địa bàn tỉnh.\n\nĐây là bước đột phá trong việc nâng cao chất lượng nông sản Khánh Hòa, tăng niềm tin của người tiêu dùng và mở rộng cơ hội xuất khẩu.`,
    date: '20/07/2026',
    category: 'Chính sách',
    author: 'Ban biên tập',
    views: 12450,
  ...
  },
  {
    ...
    excerpt: 'Hội thảo do Sở KH&CN phối hợp với Hiệp hội Doanh nghiệp Khánh Hòa tổ chức đã quy tụ đông đảo doanh nghiệp, HTX và các chuyên gia trong lĩnh vực nông nghiệp công nghệ cao.',
    content: `Hội thảo do Sở KH&CN phối hợp với Hiệp hội Doanh nghiệp Khánh Hòa tổ chức đã quy tụ đông đảo doanh nghiệp, HTX và các chuyên gia trong lĩnh vực nông nghiệp công nghệ cao.\n\nTại hội thảo, các chuyên gia nhấn mạnh tầm quan trọng của minh bạch thông tin trong chuỗi cung ứng nông sản nhằm nâng cao giá trị và mở rộng thị trường xuất khẩu.`,
    date: '15/07/2026',
    category: 'Sự kiện',
  ...
  },
  {
    ...
    excerpt: 'Doanh nghiệp và HTX có sản phẩm OCOP từ 3 sao trở lên được hỗ trợ miễn phí đăng ký tem QR Code và tích hợp vào hệ thống Khánh Hòa Trace trong năm 2026.',
    content: `Doanh nghiệp và HTX có sản phẩm OCOP từ 3 sao trở lên được hỗ trợ miễn phí đăng ký tem QR Code và tích hợp vào hệ thống Khánh Hòa Trace trong năm 2026.\n\nQuy trình đăng ký gồm 3 bước: nộp hồ sơ trực tuyến, xét duyệt trong 3-5 ngày làm việc và nhận mã truy xuất. Sau khi được cấp mã, doanh nghiệp có thể in tem QR dán lên sản phẩm.`,
    date: '10/07/2026',
    category: 'Hướng dẫn',
    author: 'Ban biên tập',
    views: 9870,
  ...
  },
  {
    ...
    content: `Đoàn gồm 15 doanh nghiệp Nhật Bản chuyên nhập khẩu nông sản đã đến tham quan thực tế mô hình chuỗi truy xuất nguồn gốc tại HTX Nông nghiệp Xanh, huyện Vĩnh Cửu.\n\nCác đại diện doanh nghiệp Nhật Bản đánh giá cao hệ thống truy xuất nguồn gốc của Khánh Hòa và bày tỏ sẵn sàng ký kết hợp đồng nhập khẩu nông sản có chứng nhận từ địa phương.`,
    date: '28/06/2026',
    category: 'Sự kiện',
  ...
  },
  {
    ...
    excerpt: 'Kế hoạch số 127/KH-UBND đặt mục tiêu đến năm 2027 có ít nhất 500 sản phẩm nông nghiệp của Khánh Hòa được truy xuất nguồn gốc bằng công nghệ blockchain.',
    content: `Kế hoạch số 127/KH-UBND đặt mục tiêu đến năm 2027 có ít nhất 500 sản phẩm nông nghiệp của Khánh Hòa được truy xuất nguồn gốc bằng công nghệ blockchain.\n\nTheo kế hoạch, tỉnh sẽ hỗ trợ chi phí tích hợp blockchain cho các doanh nghiệp vừa và nhỏ, đồng thời tổ chức đào tạo kỹ thuật để nâng cao năng lực ứng dụng công nghệ cho người sản xuất.`,
    date: '20/06/2026',
    category: 'Chính sách',
    author: 'Ban biên tập',
    views: 15680,
...
export const NOTIFICATIONS: NotificationItem[] = [
  {
    ...
    body: 'Hồ sơ đăng ký tham gia chương trình TXNG của tổ chức bạn đã được Sở KHCN Khánh Hòa phê duyệt. Bạn có thể bắt đầu đăng ký sản phẩm.',
    type: 'success',
    date: '15/01/2024',
    read: true,
  },
  ...
  },
  {
    ...
    body: 'Hệ thống TXNG tỉnh Khánh Hòa sẽ bảo trì từ 23:00 - 02:00 ngày 20/01/2024. Vui lòng lưu ý để không bị ảnh hưởng đến công việc.',
    type: 'info',
    date: '18/01/2024',
    read: true,
  },
