...
export const MOCK_PRODUCTS = [
  ...
  { id: 'sp002', name: 'Rau muống hữu cơ VietGAP', traceCode: 'TXNG-XL-002-2024', org: 'Trang trại Sạch Khánh Hòa', category: 'Nông sản & Rau củ', district: 'Biên Hòa', status: 'published', cert: 'VietGAP', img: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=300&h=200&fit=crop' },
  { id: 'sp003', name: 'Tôm sú đông lạnh', traceCode: 'TXNG-LT-003-2024', org: 'Công ty Thủy sản Khánh Hòa', category: 'Thủy sản', district: 'Long Thành', status: 'published', cert: 'HACCP', img: 'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?w=300&h=200&fit=crop' },
  ...
  { id: 'sp007', name: 'Mật ong rừng nguyên chất', org: 'Trang trại Ong Rừng Khánh Hòa', category: 'Thực phẩm chế biến', district: 'Tân Phú', status: 'published', cert: 'OCOP', img: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=300&h=200&fit=crop' },
  ...
  { id: 'sp010', name: 'Tiêu sọ Long Khánh', org: 'HTX Hồ Tiêu Long Khánh', category: 'Nông sản & Rau củ', district: 'Long Khánh', status: 'published', cert: 'OCOP', img: `${import.meta.env.BASE_URL}images/peppercorns-black.jpg` },
...
export const MOCK_BUSINESSES = [
  ...
  { id: 'b2',  name: 'Công ty Thủy sản Khánh Hòa',         type: 'Doanh nghiệp',     district: 'Long Thành',  phone: '0251 234 567', products: 8,  cert: 'HACCP',     img: 'https://images.unsplash.com/photo-1544551763-77ef2d0cfc6c?w=300&h=200&fit=crop' },
  ...
  { id: 'b4',  name: 'Trang trại Sạch Khánh Hòa',          type: 'Trang trại',       district: 'Biên Hòa',    phone: '0251 456 789', products: 12, cert: 'VietGAP',   img: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=300&h=200&fit=crop' },
  ...
  { id: 'b8',  name: 'Trang trại Ong Rừng Khánh Hòa',      type: 'Trang trại',       district: 'Tân Phú',     phone: '0251 890 234', products: 3,  cert: 'OCOP',      img: 'https://images.unsplash.com/photo-1558642891-54be180ea339?w=300&h=200&fit=crop' },
