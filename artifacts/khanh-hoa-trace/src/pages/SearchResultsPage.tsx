...
export const MOCK_PRODUCTS = [
  { id: 'sp001', name: 'Yến sào Khánh Hòa', traceCode: 'TXNG-NTR-001-2024', org: 'HTX Yến sào Nha Trang', category: 'Nông sản & Rau củ', district: 'Nha Trang', status: 'published', cert: 'VietGAP', img: 'https://images.unsplash.com/photo-1587486913049-53fc88980cfc?w=300&h=200&fit=crop' },
  { id: 'sp002', name: 'Tôm hùm xanh Cam Ranh', traceCode: 'TXNG-CRH-002-2024', org: 'Công ty Hải sản Cam Ranh', category: 'Thủy sản', district: 'Cam Ranh', status: 'published', cert: 'VietGAP', img: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=300&h=200&fit=crop' },
  { id: 'sp003', name: 'Xoài Úc Cam Lâm', traceCode: 'TXNG-CLM-003-2024', org: 'Trang trại Xoài Cam Lâm', category: 'Trái cây', district: 'Cam Lâm', status: 'published', cert: 'HACCP', img: 'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?w=300&h=200&fit=crop' },
  { id: 'sp004', name: 'Rau an toàn Diên Khánh', org: 'HTX Nông nghiệp Diên Khánh', category: 'Nông sản & Rau củ', district: 'Diên Khánh', status: 'published', cert: 'GlobalGAP', img: 'https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?w=300&h=200&fit=crop' },
  { id: 'sp005', name: 'Tỏi trắng Vạn Ninh', org: 'HTX Tỏi sạch Vạn Ninh', category: 'Gia vị', district: 'Vạn Ninh', status: 'published', cert: 'ISO 22000', img: 'https://images.unsplash.com/photo-1574484284002-952d92456975?w=300&h=200&fit=crop' },
  { id: 'sp006', name: 'Nước mắm truyền thống Ninh Hòa', org: 'Công ty Chế biến Thủy sản Ninh Hòa', category: 'Thực phẩm chế biến', district: 'Ninh Hòa', status: 'published', cert: 'OCOP', img: 'https://images.unsplash.com/photo-1563114773-84221bd62daa?w=300&h=200&fit=crop' },
  { id: 'sp007', name: 'Mật ong rừng Khánh Vĩnh', org: 'HTX Nông sản Khánh Vĩnh', category: 'Thực phẩm chế biến', district: 'Khánh Vĩnh', status: 'published', cert: 'OCOP', img: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=300&h=200&fit=crop' },
  { id: 'sp008', name: 'Dược liệu Khánh Sơn', org: 'Trang trại Dược liệu Khánh Sơn', category: 'Dược liệu', district: 'Khánh Sơn', status: 'published', cert: 'VietGAP', img: 'https://images.unsplash.com/photo-1536304929831-ee1ca9d44906?w=300&h=200&fit=crop' },
  { id: 'sp009', name: 'Nho xanh Ninh Phước', org: 'HTX Nho sạch Ninh Phước', category: 'Trái cây', district: 'Ninh Phước', status: 'published', cert: 'ISO 22000', img: 'https://images.unsplash.com/photo-1563379926898-05f4575a45d8?w=300&h=200&fit=crop' },
  { id: 'sp010', name: 'Muối tinh khiết Ninh Hải', org: 'HTX Muối sạch Ninh Hải', category: 'Thực phẩm', district: 'Ninh Hải', status: 'published', cert: 'OCOP', img: `${import.meta.env.BASE_URL}images/peppercorns-black.jpg` },
  { id: 'sp011', name: 'Gốm thủ công Bàu Trúc', org: 'Làng nghề Gốm Bàu Trúc', category: 'Thủ công mỹ nghệ', district: 'Ninh Chu', status: 'published', cert: 'HACCP', img: 'https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=300&h=200&fit=crop' },
  { id: 'sp012', name: 'Rau hữu cơ Ninh Sơn', org: 'Trang trại Rau sạch Ninh Sơn', category: 'Nông sản & Rau củ', district: 'Ninh Sơn', status: 'published', cert: '', img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=200&fit=crop' },
];

// ─── Businesses ───────────────────────────────────────────────────────────────
export const MOCK_BUSINESSES = [
  { id: 'b1',  name: 'HTX Yến sào Nha Trang', type: 'Hợp tác xã', district: 'Nha Trang', phone: '0258 352 1234', products: 5, cert: 'VietGAP', img: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=300&h=200&fit=crop' },
  { id: 'b2',  name: 'Công ty Hải sản Cam Ranh', type: 'Doanh nghiệp', district: 'Cam Ranh', phone: '0258 385 2345', products: 8, cert: 'HACCP', img: 'https://images.unsplash.com/photo-1544551763-77ef2d0cfc6c?w=300&h=200&fit=crop' },
  { id: 'b3',  name: 'HTX Nông nghiệp Diên Khánh', type: 'Hợp tác xã', district: 'Diên Khánh', phone: '0258 376 3456', products: 3, cert: 'OCOP', img: 'https://images.unsplash.com/photo-1563114773-84221bd62daa?w=300&h=200&fit=crop' },
  { id: 'b4',  name: 'Trang trại Xoài Cam Lâm', type: 'Trang trại', district: 'Cam Lâm', phone: '0258 398 4567', products: 12, cert: 'VietGAP', img: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=300&h=200&fit=crop' },
  { id: 'b5',  name: 'HTX Tỏi sạch Vạn Ninh', type: 'Hợp tác xã', district: 'Vạn Ninh', phone: '0258 384 5678', products: 4, cert: 'OCOP', img: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=300&h=200&fit=crop' },
  { id: 'b6',  name: 'Công ty Chế biến Thủy sản Ninh Hòa', type: 'Doanh nghiệp', district: 'Ninh Hòa', phone: '0258 363 6789', products: 7, cert: 'GlobalGAP', img: 'https://images.unsplash.com/photo-1534361960057-19f073e29f93?w=300&h=200&fit=crop' },
  { id: 'b7',  name: 'HTX Nho sạch Ninh Phước', type: 'Cơ sở sản xuất', district: 'Ninh Phước', phone: '0259 388 9012', products: 2, cert: 'ISO 22000', img: 'https://images.unsplash.com/photo-1574484284002-952d92456975?w=300&h=200&fit=crop' },
  { id: 'b8',  name: 'Trang trại Dược liệu Khánh Sơn', type: 'Trang trại', district: 'Khánh Sơn', phone: '0258 386 8901', products: 3, cert: 'OCOP', img: 'https://images.unsplash.com/photo-1558642891-54be180ea339?w=300&h=200&fit=crop' },
  { id: 'b9',  name: 'HTX Muối sạch Ninh Hải', type: 'Hợp tác xã', district: 'Ninh Hải', phone: '0259 387 1234', products: 6, cert: 'VietGAP', img: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=300&h=200&fit=crop' },
  { id: 'b10', name: 'Làng nghề Gốm Bàu Trúc', type: 'Làng nghề', district: 'Ninh Chu', phone: '0259 385 2345', products: 9, cert: 'ISO 22000', img: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=300&h=200&fit=crop' },
  { id: 'b11', name: 'HTX Dê núi Bác Ái', type: 'Cơ sở sản xuất', district: 'Bác Ái', phone: '0259 382 3456', products: 4, cert: 'HACCP', img: 'https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=300&h=200&fit=crop' },
  { id: 'b12', name: 'Trang trại Rau sạch Ninh Sơn', type: 'Làng nghề', district: 'Ninh Sơn', phone: '0259 385 5678', products: 6, cert: '', img: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=300&h=200&fit=crop' },
];
