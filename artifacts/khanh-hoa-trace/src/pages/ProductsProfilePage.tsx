...
function getTraceDetail(product: Product): TraceDetail | null {
  ...
  return {
    origin: product.id === 'p1' ? 'Tân Triều, Vĩnh Cửu, Khánh Hòa' : 'Khánh Hòa',
                ...
                {activeTab === 'org' && (
                  hasTrace ? (
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-slate-600">Đơn vị chịu trách nhiệm cập nhật thông tin và xác thực hành trình sản phẩm trên hệ thống Khánh Hòa Trace.</p>
                    </div>
                  ) : (
