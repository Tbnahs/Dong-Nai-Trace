      ...
      {searched && (
        <div className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden animate-in fade-in slide-in-from-bottom-4">
          <div className="bg-emerald-50 border-b border-emerald-100 p-4 flex items-center gap-3">
            ...
            <span className="font-bold text-emerald-800">Sản phẩm đã được xác thực trên hệ thống Khánh Hòa Trace</span>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="shrink-0 flex flex-col items-center justify-center p-4 border border-dashed border-gray-300 rounded-xl bg-gray-50">
                <div className="w-32 h-32 bg-white rounded flex items-center justify-center p-2 shadow-sm border border-gray-200">
                  <div className="w-full h-full bg-[url('https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=khanhhoatrace')] bg-cover opacity-60 mix-blend-multiply"></div>
                </div>
                <span className="text-xs font-semibold text-gray-500 mt-3">Mã TXNG Khánh Hòa</span>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  <div className="relative flex items-start gap-4">
                    ...
                    <div className="pt-3">
                      ...
                      <div className="text-sm text-gray-500 mt-1">Nông trại: Khu A, HTX Nông nghiệp Xanh, Vĩnh Cửu, Khánh Hòa</div>
