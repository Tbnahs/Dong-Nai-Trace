...
const PRODUCTS: Record<string, any> = {
  sp001: {
    ...
    origin: 'Tân Triều, Vĩnh Cửu, Khánh Hòa',
    packaging: 'Túi lưới 1.0–1.5 kg/quả',
    updateDate: '15/10/2024',
    orgShort: 'HTX Nông nghiệp Xanh',
    description: 'Bưởi Tân Triều là đặc sản nổi tiếng của vùng đất Vĩnh Cửu, Khánh Hòa. Được trồng theo quy trình VietGAP, không sử dụng hóa chất độc hại, đảm bảo an toàn cho người tiêu dùng.',
    ...
    certs: [{ name: 'VietGAP', issuer: 'Sở NN&PTNT tỉnh Khánh Hòa', date: '01/10/2023', expiry: '30/09/2025', image: 'https://images.unsplash.com/photo-1589330694653-ded6df03f754?w=900&h=620&fit=crop' }],
    org: { name: 'HTX Nông nghiệp Xanh Tân Triều', address: 'Xã Tân Triều, Vĩnh Cửu, Khánh Hòa', phone: '0251 890 123', email: 'htx@nongnghi.vn', type: 'Hợp tác xã', products: 5, cert: 'VietGAP',images: [
  ...
  sp002: {
    ...
    certs: [{ name: 'VietGAP', issuer: 'Sở NN&PTNT tỉnh Khánh Hòa', date: '20/08/2023', expiry: '19/08/2025', image: 'https://images.unsplash.com/photo-1589330694653-ded6df03f754?w=900&h=620&fit=crop' }],
    org: { name: 'HTX Nông nghiệp Xuân Lộc', address: 'Xã Xuân Thọ, Xuân Lộc, Khánh Hòa', phone: '0251 555 666', email: 'htx@xuanloc.vn', type: 'Hợp tác xã', products: 4, cert: 'VietGAP' },
    journey: [
  ...
  sp003: {
    ...
    origin: 'Long Thành, Khánh Hòa',
    packaging: 'Hộp 500g',
    updateDate: '10/8/2024',
    orgShort: 'Cty Thủy sản Khánh Hòa',
    ...
    org: { name: 'Công ty Thủy sản Khánh Hòa', address: 'KCN Long Thành, Khánh Hòa', phone: '0251 234 567', email: 'info@thuysandn.vn', type: 'Doanh nghiệp', products: 8, cert: 'HACCP' },
    journey: [
      { icon: 'leaf', label: 'Nuôi trồng', date: '1/6/2024', detail: 'Tôm sú được nuôi trong ao sạch, kiểm soát môi trường nước theo tiêu chuẩn HACCP.', location: 'Ao nuôi A1 – Long Thành', org: 'Cty Thủy sản Khánh Hòa' },
      { icon: 'flask', label: 'Kiểm tra chất lượng', date: '5/8/2024', detail: 'Lấy mẫu kiểm tra kháng sinh, dư lượng hóa chất trước thu hoạch.', location: 'Lab KCS', org: 'Cty Thủy sản Khánh Hòa' },
      { icon: 'calendar', label: 'Thu hoạch', date: '8/8/2024', detail: 'Thu hoạch, phân loại theo kích cỡ, rửa sạch bằng nước muối.', location: 'Ao nuôi A1 – Long Thành', org: 'Cty Thủy sản Khánh Hòa' },
      { icon: 'package', label: 'Chế biến & Đông lạnh', date: '10/8/2024', detail: 'Đông lạnh IQF, đóng gói hút chân không, dán nhãn TXNG.', location: 'Nhà máy Long Thành', org: 'Cty Thủy sản Khánh Hòa' },
    ],
  },
};
...
const buildGeneric = (id: string, name: string, cert: string, origin: string, orgName: string, img: string) => ({
  ...
  certs: [{ name: cert, issuer: 'Sở NN&PTNT tỉnh Khánh Hòa', date: '01/01/2024', expiry: '31/12/2025', image: 'https://images.unsplash.com/photo-1589330694653-ded6df03f754?w=900&h=620&fit=crop' }],
  org: { name: orgName, address: `${origin}, Khánh Hòa`, phone: '0251 000 000', email: 'lienhe@khanhhoa.gov.vn', type: 'Tổ chức', products: 3, cert },
  journey: [
    ...
    { icon: 'truck', label: 'Phân phối', date: '20/01/2024', detail: 'Vận chuyển đến điểm bán, siêu thị, chợ địa phương.', location: 'Khánh Hòa', org: orgName },
  ],
});

// Add generic entries for map-section product IDs
const MAP_PRODUCTS: Record<string, any> = {
  p1:  buildGeneric('p1',  'Xoài Cát Hòa Lộc',       'VietGAP',  'Bình Phước, Khánh Hòa',  'HTX Nông nghiệp Bình Phước',  'https://images.unsplash.com/photo-1553279768-865429fa0078?w=600&h=500&fit=crop'),
  p3:  buildGeneric('p3',  'Chuối tiêu hồng',          'GlobalGAP','Đồng Xoài, Khánh Hòa',   'Cty TNHH Xuất khẩu Đồng Xoài','https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&h=500&fit=crop'),
  p4:  buildGeneric('p4',  'Rau muống hữu cơ',         'Hữu cơ',   'Phước Long, Khánh Hòa',  'Trang trại Phước Long Xanh',  'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=600&h=500&fit=crop'),
  p5:  buildGeneric('p5',  'Cà chua bi VietGAP',       'VietGAP',  'Bình Tân, Khánh Hòa',    'HTX Rau sạch Bình Tân',       'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&h=500&fit=crop'),
  p6:  buildGeneric('p6',  'Tiêu đen Lộc Ninh',        'OCOP 4★',  'Lộc Ninh, Khánh Hòa',   'HTX Rau sạch Lộc Ninh',       'https://images.unsplash.com/photo-1599909533731-a4f31a68a3dd?w=600&h=500&fit=crop'),
  p7:  buildGeneric('p7',  'Điều rang muối Long Hà',   'ISO 22000','Long Hà, Khánh Hòa',     'HTX Cây ăn trái Long Hà',     'https://images.unsplash.com/photo-1574226516831-e1dff420e562?w=600&h=500&fit=crop'),
  p8:  buildGeneric('p8',  'Nấm linh chi Lộc Tấn',    'VietGAP',  'Lộc Tấn, Khánh Hòa',    'Cty TNHH Nông sản Lộc Tấn',   'https://images.unsplash.com/photo-1607305387299-a3d9611cd469?w=600&h=500&fit=crop'),
  ...
  p10: buildGeneric('p10', 'Thanh long ruột đỏ',       'GlobalGAP','Xuân Lộc, Khánh Hòa',   'HTX Thanh long Xuân Lộc',     'https://images.unsplash.com/photo-1558642669-822d2db4b1ae?w=600&h=500&fit=crop'),
  p11: buildGeneric('p11', 'Sầu riêng Ri6 Hưng Thịnh','VietGAP',  'Hưng Thịnh, Khánh Hòa', 'Cty CP Nông sản Hưng Thịnh',  'https://images.unsplash.com/photo-1587132137056-bfbf0166836e?w=600&h=500&fit=crop'),
  p12: buildGeneric('p12', 'Xoài Đài Loan Dầu Giây',  'VietGAP',  'Dầu Giây, Khánh Hòa',   'HTX Xoài Đầu Giây',           'https://images.unsplash.com/photo-1553279768-865429fa0078?w=600&h=500&fit=crop'),
  p13: buildGeneric('p13', 'Rau thủy canh Nhơn Trạch','Hữu cơ',   'Nhơn Trạch, Khánh Hòa', 'Trang trại Nhơn Trạch Green', 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=600&h=500&fit=crop'),
  p14: buildGeneric('p14', 'Cam sành Cẩm Mỹ',         'OCOP 4★',  'Cẩm Mỹ, Khánh Hòa',    'Cty CP Nông nghiệp Cam Mỹ',   'https://images.unsplash.com/photo-1582979512210-7df77551e49e?w=600&h=500&fit=crop'),
  p15: buildGeneric('p15', 'Tôm thẻ chân trắng',      'ASC',      'Biên Hòa, Khánh Hòa',   'Cty TNHH Chế biến Biên Hòa',  'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?w=600&h=500&fit=crop'),
};
