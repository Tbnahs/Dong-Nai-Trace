      ...
      <div className="hidden lg:flex lg:w-[52%] relative flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 p-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="text-white font-extrabold text-2xl tracking-tight block">Khánh Hòa Trace</span>
              <span className="text-blue-200/70 text-sm uppercase tracking-widest">Sở KH&CN Khánh Hòa</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 px-12 pb-14">
          ...
          <p className="text-blue-200/75 text-sm leading-relaxed mb-10 max-w-xs">
            Hệ thống truy xuất nguồn gốc tỉnh Khánh Hòa — minh bạch, tin cậy, chuẩn quốc tế.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center bg-white overflow-y-auto px-5 sm:px-8 py-6">
        <div className={`w-full ${defaultTab === 'register' ? 'max-w-xl' : 'max-w-sm'}`}>
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <div>
              <span className="text-xl font-extrabold text-[#2740BA] block">Khánh Hòa Trace</span>
              <span className="text-xs text-gray-400 uppercase tracking-widest">Sở KH&CN Khánh Hòa</span>
            </div>
          </div>
