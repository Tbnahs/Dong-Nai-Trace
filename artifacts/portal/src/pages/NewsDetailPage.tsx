...
const NEWS_LIST = [
  {
    ...
    featured: true,
    content: `
Sở Khoa học và Công nghệ tỉnh Đồng Nai vừa chính thức ra mắt nền tảng <strong>Đồng Nai Trace</strong> — hệ thống truy xuất nguồn gốc điện tử toàn diện dành cho nông sản xuất khẩu. Đây là bước tiến quan trọng trong chiến lược phát triển nông nghiệp minh bạch, bền vững của tỉnh.
...
Theo đại diện Sở KH&CN, hệ thống sẽ giúp nâng cao giá trị và uy tín nông sản Đồng Nai trên thị trường trong và ngoài nước.
    `,
  },
  {
    id: 2,
    ...
    featured: false,
    content: `
Ngày 15/07/2026, tại Trung tâm Hội nghị tỉnh Đồng Nai, Sở Khoa học và Công nghệ phối hợp cùng Hiệp hội Doanh nghiệp tỉnh tổ chức hội thảo chuyên đề <strong>"Minh bạch chuỗi cung ứng nông sản"</strong>.
...
Hội thảo đã thông qua Tuyên bố chung về phát triển nông nghiệp minh bạch, trong đó các bên cam kết đẩy mạnh ứng dụng công nghệ số trong toàn bộ chuỗi giá trị nông sản Đồng Nai.
    `,
  },
  {
    id: 3,
    ...
    featured: false,
    content: `
Nhằm hỗ trợ các doanh nghiệp và hợp tác xã nhanh chóng tiếp cận hệ thống truy xuất nguồn gốc, Sở KH&CN Đồng Nai ban hành hướng dẫn chi tiết về quy trình đăng ký và sử dụng tem truy xuất QR Code.

<h3>Đối tượng được hỗ trợ miễn phí</h3>
Tất cả doanh nghiệp, HTX có sản phẩm OCOP từ 3 sao trở lên trên địa bàn tỉnh Đồng Nai sẽ được hỗ trợ miễn phí 100% chi phí đăng ký và in tem QR Code trong năm 2026.

<h3>Quy trình đăng ký</h3>
1. Truy cập hệ thống tại <strong>txng.dongnai.gov.vn</strong> và đăng ký tài khoản doanh nghiệp.
...
Tem QR Code phải được in rõ ràng, kích thước tối thiểu 2cm x 2cm và gắn ở vị trí dễ quét trên bao bì sản phẩm.
  ...
  },
  {
    ...
    featured: false,
    content: `
Báo cáo quý II/2026 của Sở Công Thương tỉnh Đồng Nai ghi nhận tín hiệu tích cực: các lô hàng nông sản có chứng nhận truy xuất nguồn gốc điện tử đạt mức giá bán cao hơn trung bình <strong>35%</strong> so với sản phẩm không có truy xuất.
...
Các chuyên gia kinh tế nhận định, việc ứng dụng công nghệ truy xuất không chỉ nâng cao giá trị sản phẩm mà còn mở ra cơ hội tiếp cận các thị trường xuất khẩu khó tính, tạo nền tảng phát triển bền vững cho ngành nông nghiệp tỉnh Đồng Nai.
    `,
  },
  {
    id: 5,
    ...
    featured: false,
    content: `
Ngày 28/06/2026, đoàn công tác gồm 15 doanh nghiệp Nhật Bản chuyên nhập khẩu nông sản đã đến thăm và khảo sát thực tế mô hình truy xuất nguồn gốc tại HTX Nông nghiệp Xanh, huyện Vĩnh Cửu, tỉnh Đồng Nai.
...
Sau chuyến thăm, hai phía đã ký kết biên bản ghi nhớ hợp tác, mở ra triển vọng xuất khẩu nông sản Đồng Nai vào thị trường Nhật Bản với số lượng lớn hơn trong thời gian tới.
    `,
  },
  {
    id: 6,
    ...
    featured: false,
    content: `
UBND tỉnh Đồng Nai vừa ban hành Kế hoạch số 127/KH-UBND về hỗ trợ doanh nghiệp, hợp tác xã ứng dụng công nghệ blockchain trong truy xuất nguồn gốc hàng hóa giai đoạn 2026–2027.
