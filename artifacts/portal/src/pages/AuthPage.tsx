  ...
  return (
    <>
      ...
      <div className="mt-5 text-center text-sm text-gray-500">
        Chưa có tài khoản?{' '}
        <button onClick={onSwitchToRegister} className="font-semibold text-[#2740BA] hover:text-[#1f339e] transition-colors">
...
export default function AuthPage({ defaultTab = 'login' }: { defaultTab?: 'login' | 'register' }) {
  ...
  return (
    <div className="min-h-screen flex font-sans">
      {/* ── Left branding panel ── */}
      <div className="hidden lg:flex lg:w-5/12 xl:w-2/5 bg-gradient-to-br from-[#1B2A6B] via-[#2740BA] to-[#1e3a8a] relative flex-col items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <h1 className="text-white font-extrabold text-2xl leading-tight mb-2">Đồng Nai Trace</h1>
