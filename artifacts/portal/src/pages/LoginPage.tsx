    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Dành cho Doanh nghiệp / HTX / Cơ sở sản xuất
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-slate-100">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white bg-[#E8650A] hover:bg-[#D55C08] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E8650A] transition-colors"
              >
                Đăng nhập
              </button>
            </div>
